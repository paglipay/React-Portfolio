...
function DTreeForm({ collectionData }) {
  ...
  const [formItemsCollection, setFormItemsCollection] = useState([
    {
      ...
      form_items: [
        ...
        // },
        {
          ...
          action: {
            form_items_to_dic: {
              form_items: ["ip", "username", "password", "send_cmd"],
      ...
      form_items: [
        {
          ...
          name: "Done",
          value:
            "This is completed. Would you like to email yourself the results?",
          type: "message",
        },
      ],
    },
  ...
  const toggleSizes = (n) => {
    setColSizes(
      colSizes.map((num, i) => (i === n ? (num === 8 ? 4 : 8) : num))
    );
  };
  ...
  useEffect(() => {
    ...
    if (
      ...
      collectionData.activeCollection.projects
    ) {
      let t_arry = [];
      let i = 0;
      // for (let i = 0; i < 1; i++) {
  ...
  const sendPost = (
    ...
    d = {
      "(PASSCODE): ": [""],
      custom_entry: ["echo custom_entry STUFF 1234"],
      Code: [""],
    }
  ) => {
            ...
            <Row className="mt-3">
              <LLCard title="Showcase Categories">
                ...
                <ListGroup as="ul">
                  ...
                  <ListGroup.Item as="li">Network Engineering</ListGroup.Item>
                  <ListGroup.Item as="li">DevOps</ListGroup.Item>
                  <ListGroup.Item as="li">
                    MERN-Stack Development
                  </ListGroup.Item>
                  <ListGroup.Item as="li">Python</ListGroup.Item>
                  <ListGroup.Item as="li">Network Automation</ListGroup.Item>
                  <ListGroup.Item as="li">Web Scraping</ListGroup.Item>
